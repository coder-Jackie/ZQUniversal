...
#define SCREEN_ADJUST(Value)  [UIScreen mainScreen].bounds.size.width * (Value) / 375.0

#define kActionItemHeight     60//SCREEN_ADJUST(50)
#define kLineHeight           1
#define kDividerHeight        7.5

#define kTitleFontSize        15//SCREEN_ADJUST(15)
#define kActionItemFontSize   17//SCREEN_ADJUST(17)
