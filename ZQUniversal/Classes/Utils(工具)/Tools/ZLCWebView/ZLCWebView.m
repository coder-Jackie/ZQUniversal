...
//        self.backgroundColor = ColorHex(@"f0f0f0");
        self.backgroundColor = [UIColor whiteColor];//ColorHex(@"f0f0f0");
...
#warning 这里改进度条颜色.
        //设置进度条颜色
//        [self setTintColor:[UIColor colorWithHexString:@"6B56C7"]];
        [self setTintColor:[UIColor colorWithHexString:@"ff6700"]];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if(webView == self.uiWebView) {
        ...
        if ([self.delegate respondsToSelector:@selector(zlcwebView:shouldStartLoadWithRequest:navigationType:)]) {
            [self.delegate zlcwebView:self shouldStartLoadWithRequest:request navigationType:navigationType];
        }
